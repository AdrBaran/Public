...
public class MainController implements Initializable {
    ...
    private void configureMenu() {
    	MenuItem deleteMenuItem = menuPaneController.getDeleteMenuItem();
    	ListView<String> historyListView = searchPaneController.getHistoryListView();
    	ObservableList<String> historyList = historyListView.getItems();
    	deleteMenuItem.setOnAction(x -> historyList.clear());
    }
}